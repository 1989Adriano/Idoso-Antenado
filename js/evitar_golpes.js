            ...
            <div style="height: 100%; 
                ...
                <div style="flex: 1; 
                    ...
                    <div style="background: #FFFFFF; 
                        ...
                        box-shadow: 0 2px 5px rgba(0,0,0,0.05); 
                        color: #333; 
                        line-height: 1.4;"><strong>Entregador no Portão:</strong><br>"Trouxe um presente surpresa pra você! Só precisa passar o cartão na minha maquininha para pagar a taxa de entrega de R$ 5,00."
                    </div>
                </div>
            ...
            <div style="height: 100%; 
                ...
                <div style="flex: 1; 
                    ...
                    <div style="background: #FFFFFF; 
                        ...
                        font-weight: 600; 
                        box-shadow: 0 1px 2px rgba(0,0,0,0.15); 
                        color: #222;">AVISO DA RECEITA: Seu CPF será cancelado em 24h por pendências. Regularize agora no portal: <span style="color: #0066CC; text-decoration: underline;">http://receita-regularizar.top</span>
                    </div>
                </div>
            ...
            <div style="height: 100%; 
                ...
                <div style="flex: 1; 
                    ...
                    <div style="background: #FFFFFF; 
                        ...
                        line-height: 1.3;
                        box-shadow: 0 1px 2px rgba(0,0,0,0.15); 
                        color: #222;">Prezado cliente, detectamos uma compra suspeita de R$ 2.500. Para cancelar, confirme aqui sua agência, conta e senha eletrônica de acesso.
                    </div>
                </div>
            ...
            <div style="height: 100%; 
                ...
                <div style="flex: 1; 
                    ...
                    <p style="font-size: 14px; 
                        ...
                        font-style: italic;
                        line-height: 1.3;
                        text-align: left;">"Detectamos fraudes nas suas compras. Corte o cartão ao meio e entregue para o nosso motoboy recolher agora em sua residência."
                    </p>
                </div>
                ...
                <div style="padding: 15px; 
                    ...
                    box-sizing: border-box; 
                    background: rgba(0,0,0,0.2);">
                    <button class="botao-grande botao-alerta" onclick="mostrarErro('motoboy')">Entregar Cartão Cortado</button>
                    <!-- 🌟 DIRECIONANDO PARA O MENU NO FIM DO JOGO -->

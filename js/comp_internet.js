const comp_internet = [
    //  PASSO 1: ABRIR O GOOGLE CHROME NA ÁREA DE TRABALHO
    {
        instrucao: `<strong>Passo 1:</strong> 
            ...
            Clique ou toque no ícone redondo e colorido do 'Google Chrome'.`,
        conteudo: `
    ...
    //  PASSO 2: CLICAR NA BARRA DE PESQUISA DO GOOGLE
    {
        instrucao: `<strong>Passo 2:</strong>
            ...
            clique ou toque no meio da barra de pesquisa central.`,
        conteudo: `
    ...
    //  PASSO 3: FAZER A BUSCA APÓS A SIMULAÇÃO DE DIGITAÇÃO (INPUT INTERATIVO INTEGRADO)
    {
        instrucao: `<strong>Passo 3:</strong> 
            Clique ou toque no campo branco abaixo e digite um assunto de interesse 
            real (Ex: 'receita de bolo'). Depois, clique ou toque no botão 'Buscar' para ver os resultados.`,
        conteudo: `
                <div class="net-janela-browser">
                    <div class="net-barra-navegacao">
                        <span style="color: #aaa;">⬅️ ➡️ 🔄</span>
        ...
        feedback:
        "✓ Perfeito! O Google varreu a internet e listou os melhores resultados sobre a sua pesquisa.",
    },
    ...
    //  PASSO 4: IDENTIFICAR E CLICAR NO LINK AZUL DO SITE
    {
        instrucao: `<strong>Passo 4:</strong> 
           ...
           clique ou toque em cima do primeiro 'Título Grande' escrito 
           'Bolo de Fubá Vovó - Receita Simples'.`,
        conteudo: `
                <div class="net-janela-browser">
                    <div class="net-barra-navegacao">
                        <span style="color: #aaa;">⬅️ ➡️ 🔄</span>
    ...
    //  PASSO 5: LER A RECEITA DENTRO DO SITE CARREGADO
    {
        instrucao: `<strong>Passo 5:</strong> 
            Você entrou no site de receitas! O texto mostra os
            ingredientes do bolo. Imagine que você terminou de ler e quer avançar. 
            Clique ou toque no botão 'Confirmar Leitura' no rodapé para prosseguir.`,
        conteudo: `
    ...
    //  PASSO 6: UTILIZAR A SETA DE VOLTAR DO NAVEGADOR
    {
        instrucao: `<strong>Passo 6:</strong> 
            ...
            No navegador existe uma seta apontando para a esquerda (⬅️). 
            Ela serve para retroceder. Clique ou toque na 
    ...
    //  PASSO 7: APRENDER A ABRIR UMA NOVA ABA (GUIA)
    {
        instrucao: `<strong>Passo 7:</strong>
            Quer pesquisar outra coisa sem fechar a sua receita? 
            No navegador existe um botão de sinal de mais (➕) que serve para 
            abrir uma 'Nova Aba'. Clique ou toque no 'Seta Sinal de Mais' 
            para abrir uma nova página de buscas.`,
        conteudo: `
                <div class="net-janela-browser">
        ...
        feedback:
        "✓ Excelente! Uma nova aba em branco se abriu. Agora você pode navegar em dois sites ao mesmo tempo, alternando entre as abas do navegador!",
    },

    //  PASSO 8: TELA FINAL DE SUCESSO
    {
        instrucao: `<strong>PASSO 8:</strong> 
            Parabéns! Você concluiu com sucesso este tutorial de Internet! Você aprendeu 
            com total autonomia a abrir o navegador, realizar pesquisas no Google, acessar links, 
            retornar com a seta de voltar e gerenciar novas abas com total segurança.`,
        conteudo: `
                <div style="background: white; 
                    height: auto; 
                    max-height: 100%; 
                    ...
                    <div style="background: #F8FAFC; 
                        ...
                        text-align: center; 
                        box-sizing: border-box; 
                        box-shadow: 0 3px 10 rgba(0,0,0,0.1); 
                        ...
                        <div style="background: #4285F4; 
                            ...
                            white-space: nowrap;">NAVEGAÇÃO NA WEB</div>
                        ...
                        <button onclick="window.location.href='menu.html'" 
                            ...
                            cursor: pointer; 
                            width: 100%; 
                            box-shadow: 0 3px 0 #1A56B8;
                            white-space: nowrap;">Finalizar Treino
                        </button>
                    </div>
                </div>`,
        feedback:
        "✓ Parabéns! Você concluiu com sucesso este tutorial de Internet! 🎉",
    },
];

const comp_email = [
    //  PASSO 1: ABRIR O NAVEGADOR E CLICAR NA CAIXA DE LOGIN
    {
        instrucao: `<strong>Passo 1:</strong> 
            Vamos aprender a usar o seu E-mail para receber mensagens de 
            amigos e empresas! Para começar a ler, clique ou 
            toque no campo 'Digite seu E-mail'.`,
        conteudo: `
        ...
        feedback: "✓ Muito bem! O campo de e-mail foi selecionado.",
    },
    ...
    //  PASSO 2: CONFIRMAR O ACESSO COM O BOTÃO ENTRAR
    {
        instrucao: `<strong>Passo 2:</strong> 
            ...
            Para carregar as suas mensagens recebidas,
            clique ou toque no botão 'Entrar na Caixa de Entrada'.`,
        conteudo: `
                <div class="mail-container-web" 
                    style="justify-content: center; align-items: center;">
        ...
        feedback:
        "✓ Excelente! Suas mensagens de e-mail foram carregadas na tela.",
    },
    ...
    //  PASSO 3: IDENTIFICAR UM E-MAIL VERDADEIRO DE UM AMIGO
    {
        instrucao: `<strong>Passo 3:</strong>
            ...
            Clique ou toque em cima do e-mail do 'Ricardo (Almoço de Domingo)' para abri-lo.`,
        conteudo: `
                <div class="mail-container-web">
    ...
    //  PASSO 4: LER A MENSAGEM DO AMIGO E ENCONTRAR O BOTÃO RESPONDER
    {
        instrucao: `<strong>Passo 4:</strong> 
            O e-mail do Ricardo está aberto na tela! Ele quer saber se você vai 
            levar a sobremesa. Para escrever uma resposta para ele, clique ou 
            toque no botão '↩️ Responder' no rodapé da mensagem.`,
        conteudo: `
                <div class="mail-container-web">
        ...
        feedback:
        "✓ Excelente! O campo de resposta abriu na tela para você redigir sua mensagem.",
    },

    //  PASSO 5: TREINAR A DIGITAÇÃO INTERATIVA NA CAIXA DE TEXTO DO E-MAIL
    {
        instrucao: `<strong>Passo 5:</strong> 
            Agora vamos escrever! Clique ou toque dentro do campo de texto abaixo, 
            use o teclado para digitar a resposta 'Eu vou levar o pudim sim!' e, 
            depois que escrever, clique ou toque no botão 'Avançar'.`,
        ...
        feedback:
        "✓ Fantástico! Sua mensagem de texto está escrita. Agora vamos anexar a foto nela antes de enviar.",
    },

    //  PASSO 6: LOCALIZAR O ÍCONE DO CLIPE DE PAPEL (ANEXAR)
    {
        instrucao: `<strong>Passo 6:</strong> 
            Para enviar uma foto ou documento por e-mail, nós usamos a ferramenta de 'Anexo', 
            representada em todo lugar pelo símbolo de um clipe de papel (📎). 
            Clique ou toque no 'Clipe de Papel Laranja' no rodapé para juntar a foto do doce.`,
        conteudo: `
                <div class="mail-container-web">
                        ...
                        <div class="mail-painel-conteudo">
                            ...
                            <div style="display: flex; 
                                ...
                                <span style="font-size: 12px; 
                                    color: #64748B; 
                                    font-weight: bold;">Clique no clipe para anexar um arquivo...
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        feedback:
        "✓ Excelente! O e-mail abriu a janela de arquivos para você escolher qual foto quer mandar.",
    },

    //  PASSO 7: SELECIONAR A FOTO NA JANELA DO SISTEMA
    {
        instrucao: `<strong>Passo 7:</strong> 
            A janela com suas fotos apareceu trazendo seus arquivos de imagens! 
            Clique ou toque em cima do arquivo com o desenho do pudim escrito 
            '📷 pudim.jpg' para carregá-lo no e-mail.`,
        conteudo: `
        ...
        feedback:
        "✓ Sensacional! A foto do pudim foi anexada ao e-mail. Agora vamos fazer o envio final.",
    },
    //  PASSO 8: CLICAR NO BOTÃO DE ENVIAR COM O ANEXO JUNTO
    {
        instrucao: `<strong>Passo 8:</strong>
            Repare que uma barra verde apareceu mostrando que o arquivo 'pudim.jpg' 
            está anexado ao e-mail! Para disparar o e-mail final 
            completo para o Ricardo, clique ou toque no botão 'Enviar Mensagem 🚀'.`,
        ...
        feedback:
        "✓ Perfeito! O texto e a foto foram enviados juntos e já chegaram na caixa de entrada do seu amigo.",
    },

    //  PASSO 9: RETORNAR À CAIXA DE ENTRADA
    {
        instrucao: `<strong>Passo 9:</strong> 
            Resposta com foto enviada! Agora volte para a sua listagem de e-mails 
            para checar o restante. Clique ou toque no botão 
            '📥 Entrada (1)' no menu para retornar.`,
        conteudo: `
                <div class="mail-container-web">
    ...
    //  PASSO 10: IDENTIFICAR AS ARMADILHAS DE UM E-MAIL DE GOLPE
    {
        instrucao: `<strong>Passo 10:</strong> 
            ...
            Clique ou toque para abrir esse e-mail e vamos analisar junto`,
        conteudo: `
                <div class="mail-container-web">
                            ...
                            <div onclick="avancarPasso()" 
                                ...
                                <div style="flex: 1; font-size: 11px; text-align: left;">
                                    ...
                                    <span style="color: #1E293B; 
                                        font-weight: 
                                        bold;">Sua conta será bloqueada hoje por falta de atualização!
                                    </span>
                                </div>
    ...
    //  PASSO 11: DETECTAR O REMETENTE FALSO E EXCLUIR O GOLPE
    {
        instrucao: `<strong>PASSO 11:</strong> Veja o perigo! O nome diz Banco Central, 
            mas o e-mail do remetente é "suporte-urgente@xzy-alerta.net" (totalmente falso!). 
            Além disso, há um botão vermelho ameaçador pedindo seus dados. Nunca clique ou toque nele! 
            Clique ou toque no botão "🗑️ Mandar para a Lixeira" no menu para excluí-lo.`,
        conteudo: `
                <div class="mail-container-web" style="display: flex; flex-direction: column; height: auto; max-height: 100%; box-sizing: border-box;">
                    <div class="mail-barra-topo" 
                        style="display: flex; 
                        ...
                        <span style="font-size: 13px; font-weight: bold;">🚨 Alerta de Segurança</span>
                        <!-- BOTÃO DE EXCLUSÃO PARA LIMPAR O PERIGO -->
                        <div onclick="avancarPasso()" 
                            ...
                            border-radius: 4px; 
                            cursor: pointer;
                            white-space: nowrap;">🗑️ Mandar para a Lixeira</div>
                    </div>
                    
                    <div class="mail-corpo-layout" style="display: flex; flex: 1; background: #f8fafc;">
                        <div class="mail-menu-lateral" 
                            style="width: 80px; 
                            background: #f1f5f9; 
                            padding: 6px; 
                            ...
                            <div style="opacity: 0.5; padding: 4px 2px;">📥 Entrada</div>
                            <div style="opacity: 0.5; padding: 4px 2px;">🗑️ Lixeira</div>
                        </div>
                        
                        <div class="mail-painel-conteudo" style="flex: 1; padding: 8px; box-sizing: border-box;">
                            <div style="background: #FEF2F2; 
                                ...
                                <div style="font-size: 11px; color: #EF4444; 
                                    white-space: nowrap; 
                                    overflow: hidden; 
                                    text-overflow: ellipsis;"><strong>De:</strong> suporte-urgente@xzy-alerta.net ❌ (FALSO!)
                                </div>
                                ...
                                <p style="margin: 2px 0; font-size: 12px; color: #1E293B; font-weight: bold; line-height: 1.3;">
                                    ATENÇÃO: Detectamos uma irregularidade na sua chave Pix. Evite o bloqueio imediato dos seus bens e uma multa de 
                                    <strong style="display: inline-block; 
                                        font-size: clamp(11px, 3.2vw, 13px); 
                                        white-space: nowrap; 
                                        vertical-align: baseline; 
                                        color: #EF4444;">R$ 5.000
                                    </strong> 
                                    clicando no botão abaixo para recadastrar seus documentos agora mesmo!
                                </p>
                                
                                <!-- LINK DE ARMADILHA DE ERRO -->
                                <div onclick="mostrarErro()" style="background: #EF4444;
                                    ...
                                    white-space: nowrap;">⚠️ CLIQUE AQUI PARA ATUALIZAR AGORA
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    //  PASSO 12: TELA FINAL DE SUCESSO
    {
        instrucao: `<strong>PASSO 12:</strong> 
            Parabéns! Você concluiu com sucesso este tutorial de E-mail! Você aprendeu 
            a entrar com total proteção, ler e responder e-mails de amigos enviando anexos 
            e fotos reais, e o mais importante: desmascarar e deletar e-mails falsos de criminosos com total segurança.`,
        conteudo: `
                <div style="background: white; 
                    height: auto; 
                    max-height: 100%; 
                    ...
                    <div style="background: #F8FAFC; 
                        ...
                        <div style="background: #0056B3; 
                            ...
                            white-space: nowrap;">CORREIO ELETRÔNICO SEGURO</div>
                        ...
                        <button onclick="window.location.href='menu.html'" 
                            ...
                            cursor: pointer; 
                            width: 100%; 
                            box-shadow: 0 3px 0 #002B5C;
                            white-space: nowrap;">Finalizar Treino
                        </button>
                    </div>
                </div>`,
        feedback:
        "✓ Parabéns! Você concluiu com sucesso este tutorial de E-mail! 🎉",
    },
];

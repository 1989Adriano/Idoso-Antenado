const comp_imprimir = [
    // PASSO 1: ABRIR O PROGRAMA DE IMPRESSÃO NA ÁREA DE TRABALHO
    {
        instrucao: `<strong>Passo 1:</strong> 
            Vamos aprender a passar um documento para o papel! Clique ou toque no ícone cinza escrito 'Imprimir'.`,
        conteudo: `
    ...
    // PASSO 2: ENCONTRAR E CLICAR NO ÍCONE DA IMPRESSORA NO MENU SUPERIOR
    {
        instrucao: `<strong>Passo 2:</strong> 
            O seu documento de texto apareceu! Para chamar o painel de impressão, 
            clique ou toque no pequeno desenho da '🖨️ Impressora' nas opções do aplicativo.`,
        conteudo: `
        ...
        feedback:
        "✓ Excelente! A ação abriu a janela de configurações antes do papel sair na máquina.",
    },
    ...
    // PASSO 3: ESCOLHER A IMPRESSORA CORRETA NA LISTA
    {
        instrucao: `<strong>Passo 3:</strong> 
            ...
            Clique ou toque na barra que mostra o nome da impressora escrita '🖨️ Impressora_Casa (Pronta)'`,
        conteudo: `
                <div class="imp-janela-branca">
                            ...
                            <div onclick="avancarPasso()" 
                                ...
                                <div>
                                    <small style="color: #64748B; 
                                        font-weight: bold; 
                                        display: block; 
                                        margin-bottom: 2px;">SELECIONE O APARELHO:
                                    </small>
    ...
    // PASSO 4: AJUSTAR NÚMERO DE CÓPIAS
    {
        instrucao: `<strong>Passo 4:</strong>
            O aparelho certo foi selecionado! Agora precisamos de 2 cópias desse papel.
            Clique ou toque no botão com a '▲ Seta para Cima' 
            ao lado do número para mudar para 2 cópias.`,
        conteudo: `
                <div class="imp-janela-branca">
                    <div class="imp-barra-topo">🖨️ Configurações de Impressão</div>
    ...
    // PASSO 5: ABASTECER O PAPEL NA BANDEJA
    {
        instrucao: `<strong>Passo 5:</strong> 
            Alerta do sistema! A impressora começou a piscar uma luz amarela e avisou que o papel acabou na máquina. 
            Para resolver, basta colocar folhas novas na bandeja de cima. 
            Clique ou toque na 'Bandeja Traseira' para abastecer o papel.`,
        conteudo: `
                <div style="background: #E2E8F0; 
                    ...
                    <div style="width: 240px; 
                        ...
                        <!-- BANDEJA DE ALIMENTAÇÃO TRASEIRA VAZIA -->
                        <div onclick="avancarPasso()" 
                            style="width: 160px; 
                            height: 35px; 
                            background: #0F172A; 
    ...
    // PASSO 6: ENVIAR O COMANDO FINAL DE IMPRESSÃO (BOTÃO IMPRIMIR)
    {
        instrucao: `<strong>Passo 6:</strong> 
            Tudo ajustado e abastecido! Agora só falta dar a ordem final
            para a máquina puxar o papel. Clique ou toque no botão escrito '🖨️ IMPRIMIR'.`,
        conteudo: `
                <div class="imp-janela-branca">
                    <div class="imp-barra-topo">🖨️ Configurações de Impressão</div>
    ...
    // PASSO 7 : CONFIRMAR A SAÍDA DO PAPEL FÍSICO NA BANDEJA DA IMPRESSORA
    {
        instrucao: `<strong>Passo 7:</strong> 
            Olha a mágica acontecendo! O papel físico está deslizando e saindo quentinho 
            na bandeja da sua impressora. Clique ou toque em cima das '📄 Duas Folhas Brancas' 
        ...
        conteudo: `
                <div style="background: #E2E8F0; 
                    ...
                    <h3 style="margin: 0 0 15px 0; 
                        ...
                        text-transform: uppercase; 
                        font-weight: bold;">Sua Impressora Física de Mesa
                    </h3>
    ...
    // PASSO 8: TELA FINAL DE SUCESSO
    {
        instrucao: `<strong>PASSO 8:</strong> 
            Parabéns! Você concluiu com sucesso este tutorial de Impressão! Você aprendeu 
            com total autonomia a localizar o comando de impressão, escolher a máquina pronta, 
            abastecer folhas na bandeja, configurar cópias e recolher o papel físico com total segurança.`,
        conteudo: `
                <div style="background: white; 
                    height: auto; 
                    max-height: 100%; 
                    ...
                    <div style="background: #F8FAFC; 
                        ...
                        <div style="background: #757575; 
                            ...
                            white-space: nowrap;">DOCUMENTOS NO PAPEL</div>

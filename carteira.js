...
const carteira = [
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:20px; flex:1; background:#F4F6F9; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:25px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO LARANJA PARA ALTA VISIBILIDADE -->
                    <button class="botao-grande" style="background:#1351B4; width:100%; border-radius:8px; box-shadow:0 4px 0 #0A2F66; border:3px dashed #F97316 !important;" onclick="avancarPasso()">🔑 Entrar com gov.br</button>
                </div>
            </div>`,
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:20px; flex:1; background:#FFF; display:flex; flex-direction:column; text-align:left; gap:15px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO AMARELO NO BOTÃO CONTINUAR -->
                    <button class="botao-grande" style="background:#1351B4; width:100%; border-radius:6px; margin-top:10px; box-shadow:0 4px 0 #0A2F66; border:3px dashed #FFC107 !important;" onclick="avancarPasso()">Continuar</button>
                </div>
            </div>`,
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:15px; flex:1; background:#F4F6F9; display:flex; flex-direction:column; gap:12px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ROTA 1: HABILITAÇÃO (CNH) - ADICIONADO DESTACAMENTO PONTILHADO AZUL -->
                    ...
                    <!-- 🌟 ROTA 2: VEÍCULOS (CRLV) - ADICIONADO DESTACAMENTO PONTILHADO VERDE -->
                    ...
                    <!-- 🌟 ROTA 3: INFRAÇÕES (MULTAS) - ADICIONADO DESTACAMENTO PONTILHADO LARANJA -->
            ...
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:15px; flex:1; background:#E2E8F0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:15px; box-sizing:border-box;">
                    <div style="background:#E2F0D9; border:2px solid #548235; width:100%; padding:15px; border-radius:8px; box-shadow:0 4px 10px rgba(0,0,0,0.1); box-sizing:border-box; color:#1F385C; text-align:left; font-size:13px; line-height:1.3;">
                        <div style="font-weight:bold; border-bottom:1px solid #548235; padding-bottom:4px; font-size:14px; margin-bottom:6px; color:#2E5B20; text-align:center;">CARTEIRA NACIONAL DE HABILITATION</div>
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO AMARELO -->
                    <button class="botao-grande" style="background:#1351B4; width:100%; border-radius:6px; box-shadow:0 4px 0 #0A2F66; border:3px dashed #FFC107 !important;" onclick="avancarPasso()">🔄 Ver Verso</button>
                </div>
            </div>`,
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:15px; flex:1; background:#E2E8F0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:15px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO LARANJA -->
                    <button class="botao-grande" style="background:#248A3D; width:100%; border-radius:6px; box-shadow:0 4px 0 #185E29; border:3px dashed #F97316 !important;" onclick="window.irParaPasso(2)">Voltar ao Menu</button>
                </div>
            </div>`,
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:15px; flex:1; background:#E2E8F0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:15px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO AMARELO -->
                    <button class="botao-grande" style="background:#1351B4; width:100%; border-radius:6px; box-shadow:0 4px 0 #0A2F66; border:3px dashed #FFC107 !important;" onclick="avancarPasso()">Mandar por WhatsApp</button>
                </div>
            </div>`,
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:20px; flex:1; background:#F4F6F9; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:20px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO LARANJA -->
                    <button class="botao-grande" style="background:#248A3D; width:100%; border-radius:6px; box-shadow:0 4px 0 #185E29; border:3px dashed #F97316 !important;" onclick="window.irParaPasso(7)">Ir para Multas</button>
                </div>
            </div>`,
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:15px; flex:1; background:#F4F6F9; display:flex; flex-direction:column; gap:12px; box-sizing:border-box;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO LARANJA NO CARD DA INFRAÇÃO -->
                    <div onclick="avancarPasso()" style="background:white; border:3px dashed #FD7E14; padding:12px; border-radius:8px; display:flex; align-items:center; justify-content:space-between; cursor:pointer; box-shadow:0 3px 6px rgba(0,0,0,0.05);">
    ...
    // PASSO 9 (DETALHE E CÓDIGO BANCÁRIO)
    {
        ...
        conteudo: `
            <div style="background:#FFF; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; user-select:none;">
                ...
                <div style="padding:15px; flex:1; background:#FFF; display:flex; flex-direction:column; gap:12px; box-sizing:border-box; overflow-y:auto; color:#333; text-align:left;">
                    ...
                    <!-- 🌟 ALVO: ADICIONADO CONTORNO PONTILHADO AMARELO -->
                    <button class="botao-grande" style="background:#1351B4; width:100%; border-radius:6px; font-size:18px; padding:12px; box-shadow:0 4px 0 #0A2F66; margin-top:10px; border:3px dashed #FFC107 !important;" onclick="avancarPasso()">Concluir Tutorial</button>
                </div>
            </div>`,
        feedback: "Parabéns! Pagar com desconto economiza dinheiro de forma totalmente legal."
    },

    // PASSO 10 (TELA DE VITÓRIA ADAPTADA PARA CONTROLADOR MASTER)
    {
        ...
        conteudo: `
            <div style="background:white; height:100%; display:flex; flex-direction:column; font-family:Arial, sans-serif; box-sizing:border-box; padding:20px; align-items:center; justify-content:center;">
                <div style="background:#E6F0FA; width:100%; padding:20px 15px; border-radius:12px; text-align:center; box-sizing:border-box; box-shadow:0 4px 15px rgba(0,0,0,0.15); border:3px solid #004B82; display:flex; flex-direction:column; align-items:center;">
                    ...
                    <h2 style="font-size:20px; color:#004B82; margin:0 0 10px 0; font-weight:bold; line-height:1.2;">Parabens !!!</h2>
                    ...
                    <!-- 🌟 CONECTADO COM O MOTOR DO SCRIPT MASTER: APONTANDO PARA AVANCARPASSO() -->
                    <button onclick="avancarPasso()" style="background:#004B82; color:white; border:3px dashed #FFC107; padding:12px 24px; border-radius:20px; font-size:16px; font-weight:bold; cursor:pointer; width:100%; box-shadow:0 4px 0 #0A2F66;">Finalizar e Sair</button>
                </div>
            </div>`,
